...
public class EditInvoicePrint implements Printable, ActionListener {
...
String[] textLines;
 ...
 for (int line = start; line < end; line++) {
        ...
        InvoiceTable_Class_Edit row = invoiceList.get(line);
...
float balance;
float paid;
public EditInvoicePrint(ObservableList<InvoiceTable_Class_Edit> invoiceList  ,float balance, String totalBill , String date , String invoice , String soldTo , String contact){
