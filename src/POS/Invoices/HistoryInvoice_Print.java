...
import POS.Invoices.InvoiceHistory_Controller.InvoiceTable_HistoryClass;
...
public class HistoryInvoice_Print implements Printable, ActionListener {
...
String[] textLines;
  ...
  public int print(Graphics g, PageFormat pf, int pageIndex)
        ...
        int x = 120 ,  y = 112 ; // these two are using to totaly change the posiciton of whole document form x to y cordinates
 ...
 for (int line = start; line < end; line++) {
        ...
        InvoiceTable_HistoryClass row = invoiceList.get(line);
...
public HistoryInvoice_Print(ObservableList<InvoiceTable_HistoryClass> invoiceList  ,float balance, String totalBill , String date , String invoice , String soldTo , String contact, String address){
